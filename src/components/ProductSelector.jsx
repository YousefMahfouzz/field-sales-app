...
export default function ProductSelector({ products, onAdd }) {
  ...
  return (
    <div>
      ...
      {filtered.map(product => (
        <div key={product.id} style={{ border: '1px solid var(--border)', borderRadius: 10, padding: '10px 12px', marginBottom: 8, background: 'white' }}>
