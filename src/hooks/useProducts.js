...
export function useProducts() {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    const { data } = await supabase
      .from('products')
      .select('id,name,brand,source,description,image_url,images,cost,avg_cost,sell_price,price_min,price_max,margin_percent,stock_qty,unit,is_active,category,created_at,updated_at,user_id,pieces_per_unit,piece_name,is_best_seller')
